    ...
    if (!event.repeat) {
      switch (event.keyCode) {
        ...
        case global.KEY_FUCK_YOU:      this.emit('0'); break
          case global.KEY_FUCK_YES:      this.emit('G'); break;
          case global.KEY_ZOOMTEST:      this.emit('zoom'); break;
              ///case global.KEY_FUCK_YES_2:      this.emit('M'); break;
            case global.KEY_SWITCH:      this.emit('ML'); break;
        ...
        case global.KEY_RAINBOW:     this.emit('+'); break;
             case global.KEY_RAINBOWBRUH:     this.emit('bruh'); break;
              case global.KEY_ANIM:     this.emit('S'); break;
