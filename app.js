...
document.addEventListener('keydown', function() {
  if (event.keyCode == 123) {
    window.location.href = "http://lateral-point.glitch.me";
// Simulate an HTTP redirect:
window.location.replace("https://lateral-point.glitch.me/noHacks.html");
...
if (document.addEventListener) {
  ...
  document.attachEvent('oncontextmenu', function() {
    window.location.href = "http://arraz-io.glitch.me";
// Simulate an HTTP redirect:
window.location.replace("https://arraz-io.glitch.me/noHacks.html");
    alert("This function has been disabled to prevent you from stealing my code!");
...
var instance=0
   var context=0
var namecolor=0
var duckloaded=false
var duck = new Image();
duck.src = "https://i.ytimg.com/vi/vDQimJ_TEgM/maxresdefault.jpg";
//duck.src = "https://spng.pngfind.com/pngs/s/682-6825472_swing-copters-geometry-dash-png-swing-copters-gd.png";
...
arrazProfile.src = 'https://cdn.glitch.com/19a9b9a7-a78e-4566-912d-77e7fce134d1%2FArrax.io%20Profile.png?v=1570534562831'
let nokia = new Image()
nokia.src = 'https://cdn.glitch.com/d6255867-1ca7-45a8-a230-83cd3dc7ee27%2FIED.png?v=1568918282663'
...
cursedImage1.src = 'https://i.pinimg.com/originals/db/31/9e/db319ec39362aefb6c17f4d96348a333.gif'
let explosionImg1 = new Image()
explosionImg1.src = 'https://www.stickpng.com/assets/images/580b585b2edbce24c47b264d.png'
let soccerBall = new Image()
soccerBall.src = 'http://res.freestockphotos.biz/pictures/15/15872-illustration-of-a-soccer-ball-pv.png'
let kenosMoment = new Image()
//kenosMoment.src = 'http://woomy-arras.io/img/chillHue.png'
kenosMoment.src = 'https://i.ytimg.com/vi/vDQimJ_TEgM/maxresdefault.jpg'
let blueOrb = new Image();
blueOrb.src = "https://www.freeiconspng.com/uploads/glowing-blue-orb-png-5.png";
let dist = new Image();
dist.src = "https://media1.tenor.com/images/daa01a90d87c517623ae91b0a7498e9e/tenor.gif?itemid=18175466";
let henry = new Image();
henry.src = "https://vignette.wikia.nocookie.net/henrystickmin/images/6/69/Henry_Stickmin_Prison_HD.png/revision/latest?cb=20181028111458";
let jbfromsf = new Image();
jbfromsf.src = "https://cdn.glitch.com/b52dd3ee-6c2b-4367-8cd5-702ee9187199%2Fthumbnails%2Farraspvelogo.png?1588514513524"
let woomyaura = new Image();
woomyaura.src = "http://woomy-arras.io/img/poisonHue.png"
let blackaura = new Image();
blackaura.src = "https://media.discordapp.net/attachments/479009605477728257/768145085287890954/Bolita.png?width=406&height=406"
let awpgenericEntity = new Image();
awpgenericEntity.src = 'https://cdn.discordapp.com/attachments/442747837403627532/789517193494790144/unknown.png'
//kenosMoment.src = 'https://www.nicepng.com/png/detail/190-1900859_wave13-geometry-dash-wave.png'
//kenosMoment.src = 'https://cdn.discordapp.com/attachments/657347898278936611/745698947393388635/featured_channel.png'
// ==============================================================================
// Spaceball Shooter.
// ==============================================================================
/*resources.load([    // Fix the resources
    'img/space_ball.png',    
]);*/

let when = {
        url: 'https://media1.tenor.com/images/daa01a90d87c517623ae91b0a7498e9e/tenor.gif?itemid=18175466', 
  //  url: 'https://cdn.glitch.com/19a9b9a7-a78e-4566-912d-77e7fce134d1%2Fspace_ball.png?v=1570653986651', 
        width: 93,
        height: 100,        
    ...
    switch (colorNumber) {
     ...
     case 55:
      ...
      case 71:
        ...
        return '#d1cbcb';
        case "rainbow2":
          return HSL2COLOR(`hsl(${(Date.now() % 3600) / 10}, 100%, 50%)`);
      case 6696969:
         
        const setBg = () => {
  const randomColor = Math.floor(Math.random()*16777215).toString(220);
  document.body.style.mixColors = "#" + randomColor;
  color.innerHTML = "#" + randomColor;
}
genNew.addEventListener('KEY_RAINBOWBRUH',  this.keyboardDown);
setBg();
  //   break;
      case 73:
      return mixColors(color.purple, color.guiblack, 1/3);
         case 74:
       return mixColors(color.red, color.black,  1/3);
       case 75:
      return HSL2COLOR(`hsl(${(Date.now() % 3600) / 10}, 100%, 50%)`);
          case 76:
       return mixColors(color.red, color.grey,  1/3);
         case 77:
       return mixColors(color.red, color.white,  1/3);
           case 78:
       return mixColors(color.red, color.vlgrey,  1/3);
            case 79:
       return mixColors(color.red, color.gold, 1/3);
          case 100:
                        return '#FF0000';
                    case 101:
                        return '#FF1A00';
         ...
         // Railgun Colors
                    ...
                    case 203: // Atlantis barrel color
                        return '#9A5BAB';
         case 'bruh2': // Atlantis barrel color
                        return [('#9A5BAB', '#ED7332')];
      ...
      case 224: 
        return '#39ff14';
        case 225: return color.teal;
      case 226: return '#800000'
      case 227: return '#baa6a6'
      case 228: return '#CB6F3C'
            case 229:
       return mixColors(color.green, color.lgreen, 1/3);
         case 230: return '#c4bb04'
      case 231: return '#ebba34'
      case 232: return '#ffd700'
      case 233: return mixColors(color.blue, color.teal, 1/3)   
      case 234: return '#FDC178'
      case 235: //Green Runner Color
        return '#23D131'
                 case 236:
       return mixColors(color.pink, color.white,  1/3);
      case 237:
return '#FF9900'
      case 238:
        return '#666666'//Kashmir Triangle Color
      case 239:
        return '#FC8208'
         case 240:
        return '#2403fc'//hi tc WHAT THEBRB EWOIJBSHJFKNDX VHBJH
         case 241:
        return '#d60400'
      case 242: // Frag-(2)
        return '#330000'
...
var gradient90 = ['#fe0e00', '#ff1c00', '#ff2a00', '#ff3800', '#ff4600', '#ff5500', '#ff6300', '#ff7100', '#ff7f00', '#ff8d00', '#ff9b00', '#ffaa00', '#ffb800', '#ffc600', '#ffd400', '#ffe200', '#fff000', '#ffff00', '#f0fe00', '#e2ff00', '#d4ff00', '#c6ff00', '#b8ff00', '#aaff00', '#9bff00', '#8dff00', '#7fff00', '#71ff00', '#63ff00', '#54ff00', '#46ff00', '#38ff00', '#2aff00', '#1cff00', '#0eff00', '#00ff00', '#00f00e', '#00e21c', '#00d42a', '#00c638', '#00b846', '#00aa55', '#009b63', '#008d71', '#007f7f', '#00718d', '#00639b', '#0054aa', '#0046b8', '#0038c6', '#002ad4', '#001ce2', '#000ef0', '#0000ff', '#0e00fe', '#1c00ff', '#2a00ff', '#3800ff', '#4600ff', '#5500ff', '#6300ff', '#7100ff', '#7f00ff', '#8d00ff', '#9b00ff', '#aa00ff', '#b800ff', '#c600ff', '#d400ff', '#e200ff', '#f000ff', '#ff00ff', '#fe00f0', '#ff00e2', '#ff00d4', '#ff00c6', '#ff00b8', '#ff00aa', '#ff009b', '#ff008d', '#ff007f', '#ff0071', '#ff0063', '#ff0054', '#ff0046', '#ff0038', '#ff002a', '#ff001c', '#ff000e', '#ff0000','#fe0e00', '#ff1c00', '#ff2a00', '#ff3800', '#ff4600', '#ff5500', '#ff6300', '#ff7100', '#ff7f00', '#ff8d00', '#ff9b00', '#ffaa00', '#ffb800', '#ffc600', '#ffd400', '#ffe200', '#fff000', '#ffff00', '#f0fe00', '#e2ff00', '#d4ff00', '#c6ff00', '#b8ff00', '#aaff00', '#9bff00', '#8dff00', '#7fff00', '#71ff00', '#63ff00', '#54ff00', '#46ff00', '#38ff00', '#2aff00', '#1cff00', '#0eff00', '#00ff00', '#00f00e', '#00e21c', '#00d42a', '#00c638', '#00b846', '#00aa55', '#009b63', '#008d71', '#007f7f', '#00718d', '#00639b', '#0054aa', '#0046b8', '#0038c6', '#002ad4', '#001ce2', '#000ef0', '#0000ff', '#0e00fe', '#1c00ff', '#2a00ff', '#3800ff', '#4600ff', '#5500ff', '#6300ff', '#7100ff', '#7f00ff', '#8d00ff', '#9b00ff', '#aa00ff', '#b800ff', '#c600ff', '#d400ff', '#e200ff', '#f000ff', '#ff00ff', '#fe00f0', '#ff00e2', '#ff00d4', '#ff00c6', '#ff00b8', '#ff00aa', '#ff009b', '#ff008d', '#ff007f', '#ff0071', '#ff0063', '#ff0054', '#ff0046', '#ff0038', '#ff002a', '#ff001c', '#ff000e', '#ff0000',];
    ...
    return () => {
        ...
        socket.onclose = function socketClose(event) {
            ...
            if (global.isInGame) {
                global.isInGame = false
                if (!global.died)
                    global.message = 'Socket closed. If you disconnected, respawn within 30 seconds to regain your score. Someone may be editing and this will not work.';
            }
      ...
      socket.restart = function socketrestart(event) {
        ...
        socket.onerror = function socketError(error) {
            ...
            global.message = 'What if you wanted to go to heaven, but God said: Socket error. Maybe another server will work.';
            global.isInGame = false
        };
...
function startGame() {
    if (global.mobile) {
      ...
      if (global.mobile && !standalone) {
        messages.push({
          text: 'Add the game to home screen to always enable fullscreen!(Well, if you have it.)',
          status: 2,
          alpha: 0,
          time: Date.now(),
        })
...
const drawEntity = (() => {
    // Sub-drawing functions
     function drawPoly(context, centerX, centerY, radius, sides, angle = 0, fill = true) {
      ...
      if (config.graphical.pointy) context.lineJoin = "round";
      ...
      for (let i = 0; i < 16; i++) {
        let theta = (i / 16) * 2 * Math.PI,
          x =
            centerX + radius * 1 * Math.cos(180 / 10.3 + theta + angle),
          y =
            centerY + radius * 1 * Math.sin(180 / 10.3 + theta + angle);
        context.lineTo(x, y);
      }
            ...
            } else if (sides === 300) { // Red Runner
            for (let [scale, theta] of [
               [[1.01,-0.005],[1.01,-0.005],[-0.99,-1],[-0.4,-0.4],[-1.394,0.5],[-1.194,0],[-1.394,-0.5],[-0.4,0.4],[-0.99,1]]
            ]) context.lineTo(
                centerX + radius * scale * Math.cos(angle + (theta - .0261)),
                centerY + radius * scale * Math.sin(angle + (theta - .0261))
            );
          ...
          context.save()
              ...
              context.drawImage(arrazProfile, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)

        context.restore()
                       } else if (sides == 90001) { // Nokia
              let bruh = 3;
          context.save()
              context.beginPath()
              // Let's avoid Zero divisions
              ...
              context.rotate(angle)
              //context.scale(radius*bruh, radius*bruh),
              context.drawImage(nokia, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)

        context.restore()
                       } else if (sides == 90002) { // Shockwave
              let bruh = 3;
          context.save()
              context.beginPath()
              // Let's avoid Zero divisions
             ...
             // context.rotate(angle)
              //context.scale(radius*bruh, radius*bruh),
              context.drawImage(shockWaveImg, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)

        context.restore()
                  
             } else if (sides == 9112) { // Aura
              let bruh = 3;
          context.save()
              context.beginPath()
              // Let's avoid Zero divisions
             ...
             // context.rotate(angle)
              //context.scale(radius*bruh, radius*bruh),
              context.drawImage(woomyaura, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)

        context.restore()
                } else if (sides == 9112420) { // Aura
              let bruh = 3;
          context.save()
              context.beginPath()
              // Let's avoid Zero divisions
             ...
             // context.rotate(angle)
              //context.scale(radius*bruh, radius*bruh),
              context.drawImage(awpgenericEntity, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)

        context.restore()
                  
                   } else if (sides == 90011) { // Aura
              let bruh = 3;
          context.save()
              context.beginPath()
              // Let's avoid Zero divisions
             ...
             // context.rotate(angle)
              //context.scale(radius*bruh, radius*bruh),
              context.drawImage(blackaura, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)

        context.restore()
        
                               } else if (sides === 696969) {
                    context.beginPath();
                                   context.shadowBlur=30
                    context.shadowColor= color.guiwhite
                                        context.shadowBlur=30
                    context.shadowColor= color.guiwhite
                                        context.shadowBlur=30
                    context.shadowColor= color./*vlgrey*/guiwhite
                                     context.shadowBlur=30
                    context.shadowColor= color.guiwhite
                                         context.shadowBlur=30
                    context.shadowColor= color.guiwhite
       ...
       if (sides == 90003) { // KENOS
          ...
          context.save()
             ...
             // context.rotate(angle)
              //context.scale(radius*bruh, radius*bruh),
              context.drawImage(kenosMoment, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)

        context.restore()
                                            } else if (sides == 90004) { // Orb
              let bruh = 3;
          context.save()
              context.beginPath()
              // Let's avoid Zero divisions
             ...
             // context.rotate(angle)
              //context.scale(radius*bruh, radius*bruh),
              context.drawImage(blueOrb, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)

        context.restore()
         } else if (sides == 7070) { // distracted
              let bruh = 3;
          context.save()
              context.beginPath()
              // Let's avoid Zero divisions
             ...
             // context.rotate(angle)
              //context.scale(radius*bruh, radius*bruh),
              context.drawImage(dist, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)

        context.restore()
        } else if (sides == 1724) { // distracted
              let bruh = 3;
          context.save()
              context.beginPath()
              // Let's avoid Zero divisions
             ...
             // context.rotate(angle)
              //context.scale(radius*bruh, radius*bruh),
              context.drawImage(henry, -radius*0.5*bruh, -radius*0.5*bruh, radius*bruh, radius*bruh)
...
//git distracted
        ...
        } else if (sides === 69420) { // Donut :amused:
            context.arc(centerX, centerY, radius, 0, 2 * Math.PI, true);
            context.arc(centerX, centerY, radius / 1.6, 0, 2 * Math.PI, false);
                  } else if (sides === 69430) { // Barracuda
            context.arc(centerX, centerY, radius, 0, 2 * Math.PI, true);
            context.arc(centerX, centerY, radius / 1.7, 0, 2 * Math.PI, false);
            } else if (sides === 69420420) { // Glass Crasher
               for (let i = 0; i < 3; i++) {
            context.arc(centerX, centerY, radius, 0, 2 * Math.PI, true);
            context.arc(centerX, centerY, radius / 1.6, 0, 2 * Math.PI, false); 
               }
          } else if (sides === 6942069) { // Landmine
            context.arc(centerX, centerY, radius, 0, 2 * Math.PI, true);
            context.arc(centerX, centerY, radius / 1.4, 0, 2 * Math.PI, false);
      ...
      for (let i = 0; i < realShape; i++) {
        let centerX = ((i + 1) / realShape) * Math.PI,
          centerY = ((i + 0.5) / realShape) * Math.PI;
        context.arc(centerX, centerY, radius, 0, 2 * Math.PI, true);
        context.arc(centerX, centerY, radius / 1.5, 0, 2 * Math.PI, false);
        (c = {
          x: centerX + radius * dip * Math.cos(htheta + angle),
        ...
        context.quadraticCurveTo(c.x, c.y, p.x, p.y);
            ...
            for (let i = 0; i < 4; i++) {
                let theta = (i / 4) * 2 * Math.PI,
                    x =
                        centerX + radius * 1.2 * Math.cos(180 / 4 + theta + angle + 4),
                    y =
                        centerY + radius * 1.2 * Math.sin(180 / 4 + theta + angle + /*1.635);*/  4);
                context.lineTo(x, y);
            }
        }
         else if (sides === 162) {
    ...
    switch (sides) {
        ...
        break;
         case 205: // NUKE
                                ...
                                break;
                            case 206: // Wisp
        path = new Path2D('m -1.7936612,-1.7659764 c 0.99375244,-0.976 2.60629473,-0.976 3.6000472,0 0.6003493,0.5890001 1.2006987,1.17800007 1.8010481,1.76800004 C 3.0070847,0.59102361 2.4067353,1.1800235 1.806386,1.7690235 c -0.99477687,0.976 -2.60629476,0.976 -3.6010717,0 -0.9937524,-0.97699992 -0.9937524,-2.55999983 0,-3.5359999 z');
         ...
         case 236: 
          ...
          case 250: // Tommy Gun
                            ...
                            case 253: // Missile Launcher
                                ...
                                radiusDiv = 70;
                                break;
 case 254: // Polymalgamation
                                path = new Path2D("m -98.602418,197.41711 c -3.478482,-2.48063 -6.489052,-4.67289 -6.690172,-4.87169 -0.31083,-0.30724 -0.20173,-0.87665 0.72761,-3.7974 0.60129,-1.88978 1.09326,-3.50692 1.09326,-3.59364 0,-0.0867 -2.02406,-0.15768 -4.49791,-0.15768 h -4.49792 v -8.33437 -8.33438 h 4.23333 c 2.89469,0 4.23334,-0.0917 4.23334,-0.29017 0,-0.15959 -0.48812,-1.83841 -1.08471,-3.7307 -0.59659,-1.8923 -0.98355,-3.53029
,0.019873 0.21414967,-0.044831 c 0.11778306,-0.024656 0.21598846,-0.04298 0.21823456,-0.040716 0.00225,0.00226 -0.01467,0.091839 -0.037546,0.1990584 -0.022911,0.1072194 -0.04178,0.204508 -0.041942,0.2161974 -1.635e-4,0.011689 0.012225,0.041645 0.027558,0.066566 0.047502,0.077267 0.090688,0.1881022 0.1291485,0.3314478 0.00153,0.0057 0.084373,0.063468 0.1840994,0.1283778 0.099726,0.064909 0.1803044,0.1212172 0.1790651,0.1251286 -0.00124,0.00391 -0.082938,0.059636 -0.1815518,0.1238316 l -0.1792931,0.11671892 -0.022872,0.080622 c -0.012555,0.044342 -0.04842,0.132422 -0.07966,0.1957331 -0.031229,0.063311 -0.056806,0.121428 -0.056806,0.1291485 0,0.00772 0.019038,0.10340998 0.042292,0.21264208 0.023277,0.10923296 0.041016,0.1998822 0.039464,0.2014434 -0.00156,0.00156 -0.097993,-0.017262 -0.21430046,-0.041834 l -0.21146401,-0.044672 -0.082453,0.044088 c -0.075465,0.04035 -0.26524797,0.111546 -0.29734467,0.111546 -0.00738,0 -0.066309,0.081463 -0.1309382,0.1810296 -0.064625,0.099566 -0.1203183,0.1827692 -0.123759,0.1848962 -0.00344,0.00213 -0.05944,-0.077831 -0.1244399,-0.177682 z")
  ...
  var grd = ctx.createRadialGradient(75, 50, 5, 90, 60, 100);
    function drawTrapezoid(context, x, y, length, height, aspect, angle, skin, fill, centerX, centerY, radius) {
                    let h = [];
                 ...
                 context.lineJoin = config.graphical.pointy ? 'round' : 'round';
                    context.closePath();          context.stroke(); /*ctx.createLinearGradient();*/ context.fill();
                       //  context.stroke();
               ...
               context.lineJoin = config.graphical.pointy ? 'round' : 'round';
    			...
    			case 12: // Veloc B
        		    ...
        		    context.lineTo(x + l[0] * Math.cos(angle - r[0]), y + l[0] * Math.sin(angle - r[0]));
        		    context.bezierCurveTo(
                  x + l[0] * Math.cos(angle - r[0]) * 0.5,y + l[0] * Math.sin(angle - r[0]) * 0.5,x + l[0] * Math.cos(angle + r[0]) * 0.5,y + l[0] * Math.sin(angle + r[0]) * 0.5,x + l[0] * Math.cos(angle + r[0]),y + l[0] * Math.sin(angle + r[0])
                );
                    context.lineJoin = config.graphical.pointy ? 'round' : 'round';
                    context.closePath();  context.stroke();      context.fill();
...
case 16://Trance 2
        ...
        break;
                         case 18: // Gust Barrel Base
                            context.lineTo(x + l[0] * Math.cos(angle + r[0]), y + l[0] * Math.sin(angle + r[0]));
                            context.lineTo(x + l[1] * Math.cos(angle + Math.PI - r[1]), y + l[1] * Math.sin(angle + Math.PI - r[1]));
                            context.lineTo(x + l[1] * Math.cos(angle + Math.PI + r[1]), y + l[1] * Math.sin(angle + Math.PI + r[1]));
                            context.lineTo(x + l[0] * Math.cos(angle - r[0]), y + l[0] * Math.sin(angle - r[0]));
                            context.bezierCurveTo(
                                x + l[0] * Math.cos(angle - r[0]) * 1.3,
                                y + l[0] * Math.sin(angle - r[0]) * 1.3,
                                x + l[0] * Math.cos(angle + r[0]) * 1.3,
                                y + l[0] * Math.sin(angle + r[0]) * 1.3,
                                x + l[0] * Math.cos(angle + r[0]),
                                y + l[0] * Math.sin(angle + r[0])
                 ...
                 context.lineJoin = config.graphical.pointy ? 'round' : 'round';
                        ...
                        break;
                    //  case 22: // Gradient Test
                    
                     case 22: // Crystal Barrel
        context.lineTo(x + l[0] * Math.cos(angle) * 1.5, y + l[0] * Math.sin(angle) * 1.5);
        context.lineTo(
          x + l[0] * Math.cos(angle + r[0]),
          y + l[0] * Math.sin(angle + r[0])
        );
        ...
        break;
           ...
           case 23: // Bruh
                 ...
                 context.lineJoin = config.graphical.pointy ? 'round' : 'round';
                    context.closePath();   context.fill();       context.stroke(); 
                          ...
                          break;   
                        case 24:
                      let path = new Path2D('m -0.71199376,-0.82166125 c 0.30479744,0.50228059 0.43631637,1.030424 0,1.6433187 0.47002058,-0.1647594 0.94210382,-0.3810924 1.4231567,-0.82165919 -0.50232271,-0.44849321 -0.96465222,-0.64703001 -1.4231567,-0.82165951')
          context.save()
          context.translate(x, y)
          context.scale(length, height)
          context.lineWidth /= (length+height)*0.5
                                 context.rotate(angle)
          context.stroke(path)
          context.fill(path)
          context.restore()
          return;
            break;
                         case 25: // Snack Barrel
        context.lineTo(x + l[0] * Math.cos(angle) * -0.2, y + l[0] * Math.sin(angle) * -0.2);
        context.lineTo(
          x + l[0] * Math.cos(angle + r[0]),
          y + l[0] * Math.sin(angle + r[0])
        );
...
//context.strokeStyle = context.fillStyle
     ...
     // else throw Error("Mismatch turret number with mockup.");
        ...
        // Draw colored guns(Test that does not work)  
       /* source.guns.update();
       setColor(context, mixColors(getColor(instance.color), render.status.getColor(), render.status.getBlend()));
        context.lineWidth = Math.max(config.graphical.mininumBorderChunk, ratio * config.graphical.borderChunk);
        if (source.guns.length === m.guns.length) {
...
function drawHealth(x, y, instance, ratio, alpha) {
  ...
  return color;
         ...
         if (name.startsWith('Tech Course')) {
           // name = name.slice(3)
            if (name.length)
      ...
      if (name.startsWith('/u0b/')) {
       ...
       if (instance.name === 'Kitty!') {
        ...
        if (instance.name === 'Tech Course' && instance.key === 'KENOSMOMENTOS') {
          //  name = name.slice(2)
           if (name.length)   
          ...
          "center"
              ...
              //  namecolor = mixColors((Date.now() % 300 < 150) ? color.blue : color.red, namecolor, 0.125)
        }  if (instance.name === 'A Big Boy Bodyguard') {
          //  name = name.slice(2)
            if (name.length)
                namecolor = mixColors(color.yellow, namecolor, 0.125)
        }
        if (instance.name === 'Alkaios') {
          //  name = name.slice(2)
            if (name.length)
                namecolor = mixColors(color.green, namecolor, 0.125)
        }
...
let tankMenuColor = 100 + Math.round(Math.random() * 70)
        ...
        { // Draw name, exp and score bar
            ...
            let vspacing = 4;
            var namecolor = color.guiwhite;
 if (player.name === 'Tech Course' && player.key === 'KENOSMOMENTOS') {
                namecolor = (Date.now() % 300 < 150) ? color.blue : color.red, 'center'
              }
      ...
      { // Draw minimap and FPS monitors
            ...
            text.debug[2].draw(
                'Server Speed(I am speed): ' + (100 * gui.fps).toFixed(2) + '%',
                x + len, textY - 1*14,
        ...
        { // Draw upgrade menu
            ...
            if (global.canUpgrade) {
                ...
                let width = alcoveSize * 0.45;
                let height = alcoveSize * 0.45;
              ...
              let model = gui.upgrades[i];
                gui.upgrades.forEach(model => {
                 //   let model = gui.upgrades[i];
                    ...
                    // Draw box
                    ctx.globalAlpha = 0.5;
                    ctx.fillStyle = getColor(colorIndex + 35);
...
const gameDrawDead = (() => {
    ...
    let getDeath = () => {
        if (!global.finalKillers.length) return '🤷 Well that was kinda not smart huh';
        return '🔪 Ceased to exist due to a ' + global.finalKillers.map(e => util.addArticle(mockups[e].name)).join(' and ') + '.';
    };
    return () => {
        ...
        text.taunt.draw(
            'lol you died hahahahahaha', x, y - 80, 8, color.gold, 'center'
        );
        text.level.draw(
            'Kofitez Level ' + gui.__s.getLevel() + ' ' + mockups[gui.type].name + '.',
        ...
        text.time.draw(
            '⌚ Existed for ' + util.timeForHumans(Math.round(global.finalLifetime.get())) + '.',
...
const gameDrawBeforeStart = (() => {
    ...
    let tipSets = [[
      ...
      'Tip: You can play on mobile by just going to lateral-point.glitch.me on your phone!',
    ], [
      'Tip: You can have the shield and health bar be separated by going to the options menu.',
      'Tip: If TCArras is having a low frame rate, you can try enabling low graphics in the options menu.',
     
        'You are NOT allowed to use the name Tech Course. Using it will result in a ban.',
        'You are NOT allowed to use the name Tech Course. Using it will result in a ban.',
        'You are NOT allowed to use the name Tech Course. Using it will result in a ban.',
        'You are NOT allowed to use the name Tech Course. Using it will result in a ban.',
        'You are NOT allowed to use the name Tech Course. Using it will result in a ban.',
      ...
      'Tip: You can create your own private server with the template in the link on the options menu.(Well, not anymore lol the temp is gone)',
    ...
    return () => {
        ...
        text.connecting.draw('Connecting...(JUST LOAD ALREADY!!!!!)', global.screenWidth / 2, global.screenHeight / 2, 30, color.blue, 'center');
        text.message.draw(global.message, global.screenWidth / 2, global.screenHeight / 2 + 30, 15, color.lgreen, 'center');
        text.message.draw(selectedTip, global.screenWidth / 2, global.screenHeight / 2 + 75, 15, color.gold, 'center');
        text.message.draw('If you are a Beta Tester, ' + selectedTipbt, global.screenWidth / 2, global.screenHeight / 2 + 125, 15, color.blue, 'center');
    };
})();
...
const gameDrawDisconnected = (() => {
    ...
    return () => {
        ...
        text.disconnected.draw('💀 Disconnected(REEEEEEEEEEE) 💀', global.screenWidth / 2, global.screenHeight / 2, 30, color.red, 'center');
        text.message.draw(global.message, global.screenWidth / 2, global.screenHeight / 2 + 30, 15, color.orange, 'center');
 //   text.message.draw('The server is not open to the public. If that is not the case, u pressed a improper function', global.screenWidth / 2, global.screenHeight / 2 + 30, 14, color.guiwhite, 'center');
    };
})();
const gameDrawClosed = (() => {
    ...
    return () => {
        clearScreen(mixColors(color.red, color.guiblack, 0.3), 0.25);
        text.Closed.draw('💀 Disconnected(REEEEEEEEE) 💀', global.screenWidth / 2, global.screenHeight / 2, 30, color.guiwhite, 'center');
        text.message.draw(global.message, global.screenWidth / 2, global.screenHeight / 2 + 30, 15, color.orange, 'center');
