 ...
 //   KEY_ANIM: 85,
  ...
  codeTable: [
    ...
    },
    {
      ...
      kkkkkktwo: ["Something", -4],
      kkkkkkthree: ["A gamemode", -7],
      kkkkkkfour: ["Another gamemode", -7],
       kkkkkkfive: ["Event", -7],
       kkkkkkfive2: ["Hmmmmmmmmm", -7],
  ...
  servers: [
    ...
    {             id: 'z',  type: '0unk', name: 'Private Server',         code: 'z-unknown',        at: 'private', untrusted: true },
     { visible: 2, id: 'dev',  type: '0unk', name: 'Localhost',              code: 'local-local',      at: 'localhost:8080', secure: -1 },
        { visible: 0, id: 'server',  type: '0unk', name: '4TDM',              code: 'glitch-kkkkkk',      at: 'honored-salary.glitch.me', untrusted: true, testing: true, prefer: true},
            { visible: 0, id: 'server',  type: '0unk', name: '4TDM Dominator',              code: 'glitch-kkkkkktwo',      at: 'honored-salary-dom.glitch.me', untrusted: true, testing: true, prefer: true},
             { visible: 0, id: 'server',  type: '0unk', name: 'Boss Rush',              code: 'glitch-kkkkkkthree',      at: 'honored-salary-rush.glitch.me', untrusted: true, testing: true, prefer: true},
            { visible: 0, id: 'server',  type: '0unk', name: '2TDM Mothership',              code: 'glitch-kkkkkkfour',      at: 'honored-salary-mothership.glitch.me', untrusted: true, testing: true, prefer: true},
                { visible: 0, id: 'server',  type: '0unk', name: 'Event|War mode ',              code: 'glitch-kkkkkkfive',      at: 'tc-test-event.glitch.me', untrusted: true, testing: true, prefer: true},
           // DO NOT TURN THIS ON UNLESS I, TC SAY SO   { visible: 0, id: 'server',  type: '0unk', name: 'Developer Server',              code: 'glitch-kkkkkkfive2',      at: 'dev-serv00r.glitch.me', untrusted: true, testing: false, prefer: true},
    {       
          //if (app/index.html.key.startsWith("KENOSMOMENTOS")) {
                  }
    //} else socket.onerror = socketError (Error)
    //      { visible: 1, id: 'q',  type: '0unk', name: 'Official Private Server',         code: 'z-virginia',        at: 'boltywar-ffa.glitch.me', untrusted: true },
